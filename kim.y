...
direct_declarator:
				 ...
				 |direct_declarator LP constant_expression_opt RP
				 ;
...
postfix_expression:
					...
					|postfix_expression LP arg_expression_list_opt LP
...
logical_and_expression:
						equality_expression
						|logical_and_expression AMPAMP logical_and_expression
						;

logical_or_expression:
						equality_expression
						|logical_or_expression BARBAR logical_or_expression
						;
